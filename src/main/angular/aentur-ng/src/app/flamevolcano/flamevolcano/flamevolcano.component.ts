...
@Component({
  selector: 'app-flamevolcano',
  templateUrl: './flamevolcano.component.html',
  styleUrls: ['./flamevolcano.component.css']
})
export class FlamevolcanoComponent implements OnInit {

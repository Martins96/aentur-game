...
@Component({
  selector: 'app-frozenmountains-boss-success',
  templateUrl: './frozenmountains-boss-success.component.html',
  styleUrls: ['./frozenmountains-boss-success.component.css']
})
export class FrozenmountainsBossSuccessComponent implements OnInit {

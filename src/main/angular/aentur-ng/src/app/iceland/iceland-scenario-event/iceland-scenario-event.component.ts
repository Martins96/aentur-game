...
@Component({
  selector: 'app-iceland-scenario-event',
  templateUrl: './iceland-scenario-event.component.html',
  styleUrls: ['./iceland-scenario-event.component.css']
})
export class IcelandScenarioEventComponent implements OnInit {

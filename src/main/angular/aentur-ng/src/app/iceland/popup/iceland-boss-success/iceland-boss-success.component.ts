...
@Component({
  selector: 'app-iceland-boss-success',
  templateUrl: './iceland-boss-success.component.html',
  styleUrls: ['./iceland-boss-success.component.css']
})
export class IcelandBossSuccessComponent implements OnInit {

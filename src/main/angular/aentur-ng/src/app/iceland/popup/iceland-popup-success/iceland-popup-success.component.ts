...
@Component({
  selector: 'app-iceland-popup-success',
  templateUrl: './iceland-popup-success.component.html',
  styleUrls: ['./iceland-popup-success.component.css']
})
export class IcelandPopupSuccessComponent implements OnInit {

  reward: RewardVO|undefined=undefined;

  constructor(
    public dialogRef: MatDialogRef<IcelandPopupSuccessComponent>,

...
import { IcelandPopupSuccessComponent } from '../popup/iceland-popup-success/iceland-popup-success.component';

@Component({
  selector: 'app-iceland-scenario-enemy',
  templateUrl: './iceland-scenario-enemy.component.html',
  styleUrls: ['./iceland-scenario-enemy.component.css']
})
export class IcelandScenarioEnemyComponent implements OnInit {
  ...
  openDialogSuccess() {
    ...
    this.dialogSuccess.open(IcelandPopupSuccessComponent, dialogConfig)

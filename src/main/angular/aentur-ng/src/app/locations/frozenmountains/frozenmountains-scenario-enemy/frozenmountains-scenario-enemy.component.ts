...
import { FrozenmountainsPopupFailureComponent } from '../popup/frozenmountains-popup-failure/frozenmountains-popup-failure.component';
import { FrozenmountainsPopupSuccessComponent } from '../popup/frozenmountains-popup-success/frozenmountains-popup-success.component';

@Component({
  selector: 'app-frozenmountains-scenario-enemy',
  templateUrl: './frozenmountains-scenario-enemy.component.html',
  styleUrls: ['./frozenmountains-scenario-enemy.component.css']
})
export class FrozenmountainsScenarioEnemyComponent implements OnInit {
  ...
  ngOnInit(): void {
    const observ: Observable<HttpResponse<number>> = this.rest
        .sendGet<number>("/api/location/frozenmountains/random/lvl"+this.monsterLvl, new HttpHeaders({
  ...
  openDialogSuccess() {
    ...
    this.dialogSuccess.open(FrozenmountainsPopupSuccessComponent, dialogConfig)
  ...
  openDialogFailure() {
    ...
    this.dialogFail.open(FrozenmountainsPopupFailureComponent, dialogConfig);
  }

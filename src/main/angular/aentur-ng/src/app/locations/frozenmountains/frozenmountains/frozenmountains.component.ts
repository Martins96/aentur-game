...
@Component({
  selector: 'app-frozenmountains',
  templateUrl: './frozenmountains.component.html',
  styleUrls: ['./frozenmountains.component.css']
})
export class FrozenmountainsComponent implements OnInit {

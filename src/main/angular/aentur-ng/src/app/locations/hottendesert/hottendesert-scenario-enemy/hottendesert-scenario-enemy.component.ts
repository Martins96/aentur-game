...
import { HottendesertPopupSuccessComponent } from '../popup/hottendesert-popup-success/hottendesert-popup-success.component';

@Component({
  selector: 'app-hottendesert-scenario-enemy',
  templateUrl: './hottendesert-scenario-enemy.component.html',
  styleUrls: ['./hottendesert-scenario-enemy.component.css']
})
export class HottendesertScenarioEnemyComponent implements OnInit {
  ...
  ngOnInit(): void {
    const observ: Observable<HttpResponse<number>> = this.rest
        .sendGet<number>("/api/location/hottendesert/random/lvl"+this.monsterLvl, new HttpHeaders({
  ...
  openDialogSuccess() {
    ...
    this.dialogSuccess.open(HottendesertPopupSuccessComponent, dialogConfig)

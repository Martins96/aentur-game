...
@Component({
  selector: 'app-crimsoncave-boss-success',
  templateUrl: './crimsoncave-boss-success.component.html',
  styleUrls: ['./crimsoncave-boss-success.component.css']
})
export class CrimsoncaveBossSuccessComponent implements OnInit {

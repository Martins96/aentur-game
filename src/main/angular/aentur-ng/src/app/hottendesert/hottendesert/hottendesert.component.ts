...
@Component({
  selector: 'app-hottendesert',
  templateUrl: './hottendesert.component.html',
  styleUrls: ['./hottendesert.component.css']
})
export class HottendesertComponent implements OnInit {

...
@Component({
  selector: 'app-hottendesert-popup-success',
  templateUrl: './hottendesert-popup-success.component.html',
  styleUrls: ['./hottendesert-popup-success.component.css']
})
export class HottendesertPopupSuccessComponent implements OnInit {

  reward: RewardVO|undefined=undefined;

  constructor(
    public dialogRef: MatDialogRef<HottendesertPopupSuccessComponent>,

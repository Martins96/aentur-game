...
@Component({
  selector: 'app-darkwood-boss-success',
  templateUrl: './darkwood-boss-success.component.html',
  styleUrls: ['./darkwood-boss-success.component.css']
})
export class DarkwoodBossSuccessComponent implements OnInit {

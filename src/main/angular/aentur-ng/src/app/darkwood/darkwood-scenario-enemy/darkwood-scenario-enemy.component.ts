...
import { DarkwoodPopupSuccessComponent } from '../popup/darkwood-popup-success/darkwood-popup-success.component';

@Component({
  selector: 'app-darkwood-scenario-enemy',
  templateUrl: './darkwood-scenario-enemy.component.html',
  styleUrls: ['./darkwood-scenario-enemy.component.css']
})
export class DarkwoodScenarioEnemyComponent implements OnInit {
  ...
  ngOnInit(): void {
    const observ: Observable<HttpResponse<number>> = this.rest
        .sendGet<number>("/api/location/darkwood/random/lvl"+this.monsterLvl, new HttpHeaders({
  ...
  openDialogSuccess() {
    ...
    this.dialogSuccess.open(DarkwoodPopupSuccessComponent, dialogConfig)

...
public class ItemsListDB {
	...
	public static final ItemDTO[] ITEMS = new ItemDTO[] {
			...
			new ItemDTO(15, "Lama del ghiaccio", ItemCategory.WEAPON, "Lancia 4 volte il dato, tieni il risultato dispari migliore, se sono tutti pari tieni il piu' alto", 7, false, 60),
			new ItemDTO(16, "Lancia fiammante", ItemCategory.WEAPON, "Lancia 4 volte il dato, tieni il risultato pari migliore, se sono tutti dispari tieni il piu' alto", 7, false, 60),
			...
			new ItemDTO(30, "Corazza del tuono", ItemCategory.ARMOR, "Lancia 4 volte il dato, tieni il risultato dispari migliore, se sono tutti pari tieni il piu' alto", 7, false, 60),
			new ItemDTO(31, "Corazza del re oscuro", ItemCategory.ARMOR, "Lancia 4 volte il dato, tieni il risultato pari migliore, se sono tutti dispari tieni il piu' alto", 7, false, 60),

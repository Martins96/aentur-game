...
public class HDDesertMerchantEvent implements EventAction {
	...
	public ImmutablePair<EventResponseVO, Entry<Integer, String>> apply(int choice, int rollD100, int rollD12) {
		...
		case 2:
			return ImmutablePair.of(buyAction(rollD100, rollD12), null);
		case 3:
			return ImmutablePair.of(playAction(rollD100, rollD12), null);
	...
	private EventResponseVO buyAction(int rollD100, int rollD12) {
		String eventResultMessage;
		String eventResultImage;
	...
	private EventResponseVO playAction(int rollD100, int rollD12) {
		String eventResultMessage;
		String eventResultImage;

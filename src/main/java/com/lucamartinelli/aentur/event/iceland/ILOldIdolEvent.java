	...
	private Object inspectAction(int rollD100, int rollD12) {
		...
		if (rollD12 < 5) {
			if (percentTest(rollD100)) {
				eventResultMessage = "Ti avvicini e leggi la scritta: " + IDOL_TEXT + ". Allora mostri "
			...
			if (percentTest(rollD100)) {
				...
				eventResultMessage = "Ti avvicini e leggi la frase incisa ai piedi della statua: " + IDOL_TEXT + ". A quel punto "
				...
				eventResultMessage = "Ti avvicini e leggi la frase incisa ai piedi della statua: " + IDOL_TEXT + ". Ridacchi pensando "
			...
			if (percentTest(rollD100)) {
				if (playerInventoryDB.getGold() > 0) {
					...
					eventResultMessage = "Ti avvicini e leggi la frase incisa ai piedi della statua: " + IDOL_TEXT + ". Cerchi nella "
				...
				eventResultMessage = "Ti avvicini e leggi la frase incisa ai piedi della statua: " + IDOL_TEXT + ". Ti inchini, ma non "

...
public class DWStrangeMushroomEvent implements EventAction {
	...
	public ImmutablePair<EventResponseVO, Entry<Integer, String>> apply(int choice, int rollD100, int rollD12) {
		switch (choice) {
			...
			case 2:
				return ImmutablePair.of(cookAction(rollD100, rollD12), null);
			case 3:
				return ImmutablePair.of(toWeaponAction(rollD100, rollD12), null);
	...
	private EventResponseVO cookAction(int rollD100, int rollD12) {
		String eventResultMessage;
		String eventResultImage;
	...
	private EventResponseVO toWeaponAction(int rollD100, int rollD12) {
		String eventResultMessage;
		String eventResultImage;
